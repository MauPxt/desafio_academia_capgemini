...
def pares_anagramas_parciais(palavra):
    ...
    valores_aceitaveis = {
        chave: valor for chave, valor in contagem.items() if valor >= 2
    }
    # print(
    #     f'Valores que formam anagramas válidos para a palavra '
    ...
    return sum(sum(range(i)) for i in valores_aceitaveis.values())


if __name__ == '__main__':
    print(
        'O número de pares de substrings que são anagramas é igual a:',
